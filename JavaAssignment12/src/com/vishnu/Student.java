...
public class Student {
    ...
    {
        return "Id:"+getId()+" Name:"+getName()+" Age:"+getAge()+" Gender:"+getGender()+" engDepartment:"+getEngDepartment()+" year of enrollment t:"+getYearOfEnrollment()+" perTillDate:"+getPerTillDate();
    }
}
